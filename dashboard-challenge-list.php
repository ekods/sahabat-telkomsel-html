<?php include('header-2.php'); ?>
              ...
              <div id="exTab1" class="tabs-page">
                 <div class="container">
                    <ul class="nav nav-pills">
                       ...
                       <li>
                          <a href="#postingcontent" data-toggle="tab" aria-expanded="true">Posting Konten</a>
                       </li>
                    </ul>
                 </div>
              </div>
     ...
     <div class="w-100 py-3">
        <div class="container">
           ...
           <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane fade" id="postingcontent">
                 <div class="tabs-grid-title py-3">
                    <div class="tabs-grid-title-1">
                       <h4>Menampilkan 3,200 Postingan Challenge buat kamu.</h4>
                    </div>
                    <div class="mb-3 mt-3 nav-grid">
                       ...
                       <ul class="nav nav-pills views-post align-items-center">
                          <li class="d-flex align-items-center">
                             <a class="active" href="#grid-view-2" data-toggle="tab" aria-expanded="true">
                             <img src="img/st/grid-view.png" alt="">
                             </a>
                          </li>
                          <li class="d-flex align-items-center">
                 ...
                 <div class="tab-pane active" id="grid-view-2">
                   ...
                   <div class="mb-5">
                     <div class="filter-table">
                       <input class="form-control form-datetime" id="daterange_challenge_posting" autocomplete="off" placeholder="Tgl Mulai - Tgl Selesai">
                 ...
                 <div class="tab-pane" id="list-view-2">
                    <div class="ml-3 view-list-table">
                       <<div class="view-list-table">
                          <table id="data_challenge_posting" class="table table-bordered-1 table-hover dt-responsive" width="100%">
                             <thead class="border-head">
                                <tr>
                                   <th class="align-middle">No</th>
                                   <th class="align-middle">Postingan Challenge</th>
  ...
  <script>
      $(document).ready(function(){
        ...
        $("#data_challenge_posting").DataTable(
            {
              "scrollX": true,
              "paging": true
            }
        ...
        $("#daterange_challenge_posting").on("apply.daterangepicker", function(ev, picker) {
          $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
          var date = Date.parse(data[1]);
