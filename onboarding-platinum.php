          ...
          <div class="col-md-7 pull-right">
            ...
            <div class="box-inner-50">
              ...
              <div class="section-title m-top-60  m-bottom-60">
                  ...
                  <p class="section-subtitle wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">Kamu dapat menggunakan sistem benefit dengan metode rate card</p>
              </div>
              ...
              <div class="onboarding-wrap">
                ...
                <div class="onboarding-box">
                  <div class="onboarding-img">
                    <img src="img/st/ratecard-icon.svg" alt="">
                  </div>
                  <div class="onboarding-content">
                    <h4 class="bold font-telkomselbatiksans">Rate Card</h4>
                    <h6>Harga yang tertera di Rate Card akan ditentukan oleh Sahabat Telkomsel yang sesuai denganmu</h6>

                    <a href="#" data-toggle="modal" data-target="#mekanismeModal" class="notes fred">
                        <i class="fa fa-info-circle"></i>
                        <p>Mekanisme Penentuan Rate</p>
                    </a>
                  </div>
                </div>
