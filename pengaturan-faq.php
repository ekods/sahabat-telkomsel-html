<?php include('header-2.php'); ?>
    ...
    <section class="head-faq mb-5">
      ...
      <div class="head-faq-ornament"></div>
    </section>
              ...
              <div class="col-12 mb-4">
                  <div class="accordion" id="accordionExample">
                      <div class="mb-3">
                          ...
                          <div id="faq-ans-1" class="faq-ans show collapse in" aria-labelledby="faq-1" data-parent="#accordionExample">
                              <div class="card-body">
                      ...
                      <div class="mb-3">
                          <div class="faq-wrapper" id="faq-2">
                              <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#faq-ans-2" aria-expanded="true" aria-controls="faq-ans-2">
                                  <div class="faq-icon-wrapper d-inline-block">
                                      <img src="img/st/plus-icon.svg" alt="">
                                  </div>
                          ...
                          <div id="faq-ans-2" class="faq-ans collapse" aria-labelledby="faq-2" data-parent="#accordionExample">
                              <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                              </div>
                          </div>
                      ...
                      <div class="mb-3">
                          <div class="faq-wrapper" id="faq-3">
                              <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#faq-ans-3" aria-expanded="true" aria-controls="faq-ans-3">
                                  <div class="faq-icon-wrapper d-inline-block">
                                      <img src="img/st/plus-icon.svg" alt="">
                                  </div>
                          ...
                          <div id="faq-ans-3" class="faq-ans collapse" aria-labelledby="faq-3" data-parent="#accordionExample">
                              <div class="card-body">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                              </div>
                          </div>
